...
export default function LightSource() {
    ...
    return (
        <>
            ...
            <directionalLight castShadow color="orange" position={[7, 25, -20]} intensity={3.2} shadowMapHeight={256} shadowMapWidth={256} shadow-bias={-0.006} shadow-normalBias={0.01}>
