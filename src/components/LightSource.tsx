...
export default function LightSource() {
    ...
    return (
        <>
            ...
            <directionalLight castShadow color="orange" position={[7, 25, -20]} intensity={3.2} shadow-mapSize-height={256} shadow-mapSize-width={256} shadow-bias={-0.006} shadow-normalBias={0.01}>
